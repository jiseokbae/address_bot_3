...
from insert_address_multi import _build_component_spans
...
def _build_occurrence_address_items(
    ...
    address_plan 예:
    [
        {"occurrence_idx": 1, "group": "A", "form": "full"},
        {"occurrence_idx": 2, "group": "B", "form": "shallow"},
        ...
    ]

    occurrence_idx 순서와 text 안 placeholder 등장 순서가 일치해야 함.
    """
    ...
    for expected_idx, item in enumerate(sorted_plan, start=1):
        ...
        address_item = _get_address_item_from_bundle(
